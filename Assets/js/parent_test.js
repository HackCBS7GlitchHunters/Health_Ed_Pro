...
function getResultMessage(score) {
    ...
    if (score <= 5) {
        message = `<strong>Your score is ${score}/34. This indicates low levels of emotional or behavioral difficulties.</strong><br>`;
        ...
        message = `<strong>Your score is ${score}/34. This indicates mild emotional or behavioral difficulties.</strong><br>`;
        message += `
        ...
        message = `<strong >Your score is ${score}/34. This indicates moderate emotional or behavioral difficulties.</strong><br>`;
        message += `
        ...
        message = `<strong>Your score is ${score}/34. This indicates significant emotional or behavioral difficulties.</strong><br>`;
        message += `
        ...
        message = `<strong>Your score is ${score}/34. This indicates severe emotional or behavioral difficulties.</strong><br>`;
        message += `
